...
CP_API void				CP_System_ShowConsole				(void);
...
// SETTINGS:
//		Render settings
CP_API void				CP_Settings_Background				(CP_Color c);
...
//		HSVA values are h (0-360), s (0-100), v (0-100), a (0-255)
CP_API CP_Color			CP_Color_Create						(int r, int g, int b, int a);
CP_API CP_Color			CP_Color_Lerp						(CP_Color a, CP_Color b, float t);
CP_API CP_Color			CP_Color_FromColorHSV				(CP_ColorHSV hsv);
CP_API CP_ColorHSV		CP_ColorHSV_Create					(int h, int s, int v, int a);
CP_API CP_ColorHSV		CP_ColorHSV_Lerp					(CP_ColorHSV a, CP_ColorHSV b, float t);
CP_API CP_ColorHSV		CP_ColorHSV_FromColor				(CP_Color rgb);
...
CP_API void				CP_Image_DrawSubImage				(CP_Image img, float x, float y, float w, float h, float s0, float t0, float s1, float t1, int alpha);
...
CP_API void				CP_Image_GetPixelData				(CP_Image img, unsigned char* pixelDataOutput);
CP_API int				CP_Image_GetPixelBufferSize			(CP_Image img);
CP_API void				CP_Image_UpdatePixelData			(CP_Image img, unsigned char* pixelDataInput);
...
CP_API int				CP_Input_KeyTriggered				(CP_KEY keyCode);
CP_API int				CP_Input_KeyReleased				(CP_KEY keyCode);
CP_API int				CP_Input_KeyDown					(CP_KEY keyCode);
CP_API int				CP_Input_MouseTriggered				(CP_MOUSE button);
CP_API int				CP_Input_MouseReleased				(CP_MOUSE button);
CP_API int				CP_Input_MouseDragged				(CP_MOUSE button);
CP_API int				CP_Input_MouseDown					(CP_MOUSE button);
CP_API int				CP_Input_MouseMoved					(void);
CP_API int				CP_Input_MouseClicked				(void);
CP_API int				CP_Input_MouseDoubleClicked			(void);
...
CP_API int				CP_Input_GamepadTriggered			(CP_GAMEPAD button);
CP_API int				CP_Input_GamepadTriggeredAdvanced	(CP_GAMEPAD button, int gamepadIndex);
CP_API int				CP_Input_GamepadReleased			(CP_GAMEPAD button);
CP_API int				CP_Input_GamepadReleasedAdvanced	(CP_GAMEPAD button, int gamepadIndex);
CP_API int				CP_Input_GamepadDown				(CP_GAMEPAD button);
CP_API int				CP_Input_GamepadDownAdvanced		(CP_GAMEPAD button, int gamepadIndex);
...
CP_API int				CP_Input_GamepadConnected			(void);
CP_API int				CP_Input_GamepadConnectedAdvanced	(int gamepadIndex);
...
CP_API unsigned int		CP_Random_GetBool					(void);
